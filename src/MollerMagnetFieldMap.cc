...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MollerMagnetFieldMap::InitializeGrid()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MollerMagnetFieldMap::ReadFieldMap(const char* filename)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo...... 
void MollerMagnetFieldMap::GetFieldValue(const G4double Point[4], G4double *Bfield ) const
{
...
} //end of MollerMagnetFieldMap::GetFieldValue()

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MollerMagnetFieldMap::PrintFieldCheck(const char* filenamechar)
{

	G4cout << G4endl << "###### Calling MollerMagnetFieldMap::PrintFieldCheck() " << G4endl << G4endl;
...
// 		   pointin[0],pointin[1]/degree,pointin[2],bfieldout[0],bfieldout[1]/degree,bfieldout[2]);
	...
	if (1) {
 	...
 	fclose(checkFile);
	G4cout << G4endl << "###### Leaving MollerMagnetFieldMap::PrintFieldCheck() " << G4endl << G4endl;

}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MollerMagnetFieldMap::GetFieldValueFromGridCell( const G4int GridPoint_R,
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MollerMagnetFieldMap::PrintGridCheck(const char* filenamechar)
{

	G4cout<<"###### Calling MollerMagnetFieldMap::PrintGridCheck() "<<G4endl;
	G4cout<<"###### Calls MollerMagnetFieldMap::GetFieldValueFromGridCell() "<<G4endl<<G4endl;
	...
	G4cout<<"###### Leaving MollerMagnetFieldMap::PrintGridCheck() "<<G4endl<<G4endl;
}
...
// 
//      $Revisions$  
//      $Log: MollerMagnetFieldMap.cc,v $
//      Revision 1.3  2006/01/06 21:40:45  grimm
//        Increased phi_index from 43 to 44 , no crash so far
//        if (phi_index > 44)
//
//      Revision 1.2  2005/12/27 19:12:49  grimm
