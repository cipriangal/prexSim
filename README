...
If you have a feature in your fork and you would like to make it available to other you can create a pull request. [[https://help.github.com/articles/creating-a-pull-request/][Pull Request Documentation]]

This repository contains multiple branches for working on different issues. You can see the list of branches at the top of the file list. If you want to create your own branch follow instrucations at [[https://git-scm.com/book/en/v2/Git-Branching-Basic-Branching-and-Merging][basic branching]].
